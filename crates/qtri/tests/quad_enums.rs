...
#[test]
fn quad_enums_example_runs_and_matches_output() {
    ...
    let example = repo_root().join("examples").join("quad").join("enums.quad");
    ...
    // 1) Build the example via the stage0 driver.
    ...
    // 2) Run the built executable and validate output.
